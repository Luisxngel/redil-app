...
import '../../features/members/domain/repositories/member_repository.dart'
    as _i5;
import '../../features/members/presentation/bloc/members_bloc.dart' as _i10;
import '../services/communication_service.dart' as _i3;
import '../services/statistics_service.dart' as _i11;
import '../theme/theme_cubit.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i10.MembersBloc>(() => _i10.MembersBloc(
    ...
    gh.factory<_i13.DashboardBloc>(() => _i13.DashboardBloc(
          gh<_i11.StatisticsService>(),
          gh<_i8.AttendanceRepository>(),
        ));
    return this;
  }
